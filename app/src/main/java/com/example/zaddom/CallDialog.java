...
public class CallDialog extends DialogFragment {
    ...
    public CallDialog(String imie) {
        this.imie = imie;
    }
    static CallDialog newInstance(String imie){
        return new CallDialog(imie);
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setMessage(getString(R.string.call_question)+" "+imie);
